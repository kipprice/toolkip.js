...
KIP.Objects.Drawable.prototype.Draw=function(a,b,c){var d;if(this.div){this.parent=a||this.parent;this.Refresh();if(this.elderSiblings&&0<this.elderSiblings.length)for(a=0;a<this.elderSiblings.length;a+=1)d=this.elderSiblings[a],d.parentNode&&!b&&d.parentNode.removeChild(d),this.parent.appendChild(d);this.div.parentNode&&!b&&this.div.parentNode.removeChild(this.div);c?this.parent.insertBefore(this.div,c):this.parent.appendChild(this.div);if(this.youngerSiblings&&0<this.youngerSiblings.length)for(a=
