window.KIP||(window.KIP={Objects:{},Functions:{},Constants:{},Globals:{StylesAdded:{}},Options:{},Test:{},Events:{}});try{KIP.Events.CSSChange=new Event("csschange")}catch(a){console.log("No event")}KIP.Functions.CreateSimpleElement=function(a,b,c,d,e,f){var g;g={};g.id=a;g.type="div";g.content=c;g.cls=b;g.attr=d;g.children=e;g.parent=f;return KIP.Functions.CreateElement(g)};
KIP.Functions.CreateSimpleLabeledElement=function(a,b,c,d,e,f,g,h){if(!(void 0===d||null===d||"string"===typeof d&&0===KIP.Functions.Trim(d).length||h&&0===d))return h={},h.id=a,h.type="div",h.cls=b,h.attr=e,h.children=f,h.parent=g,a={cls:"lbl",content:c,type:"span"},d={cls:"content",content:d,type:"span"},h.children=[a,d],KIP.Functions.CreateElement(h)};
KIP.Functions.CreateElement=function(a){var b,c,d,e;b=document.createElement(a.type||"div");a.id&&b.setAttribute("id",a.id);if(a.cls)if("string"===typeof a.cls)b.setAttribute("class",a.cls);else if("object"===typeof a.cls)for(e in a.cls)a.cls.hasOwnProperty(e)&&(KIP.Functions.CreateCSSClass(e,a.cls[e]),KIP.Functions.AddCSSClass(b,e));if(a.before_content||0===a.before_content)b.innerHTML=a.before_content;if(a.content||0===a.content)b.innerHTML+=a.content;for(d in a.children)a.children.hasOwnProperty(d)&&
a.children[d]&&(a.children[d].setAttribute?b.appendChild(a.children[d]):(e=KIP.Functions.CreateElement(a.children[d]),b.appendChild(e)));for(c in a.attr)a.attr.hasOwnProperty(c)&&a.attr[c]&&(a.attr[c].key?"value"===a.attr[c].key?b.value=a.attr[c].val:b.setAttribute(a.attr[c].key,a.attr[c].val):"value"===c?b.value=a.attr[c]:b.setAttribute(c,a.attr[c]));if(a.after_content||0===a.after_content)b.innerHTML+=a.after_content;a.parent&&a.parent.appendChild(b);return b};
KIP.Functions.AddCSSClass=function(a,b){var c;a&&b&&(a.Draw&&(a=a.div),KIP.Events.CSSChange&&a.dispatchEvent&&a.dispatchEvent(KIP.Events.CSSChange),(c=a.getAttribute("class"))?(c=" "+c+" ",-1===c.indexOf(" "+b+" ")&&a.setAttribute("class",KIP.Functions.Trim(c+b))):a.setAttribute("class",b))};
KIP.Functions.RemoveCSSClass=function(a,b){var c,d;a&&b&&(a.Draw&&(a=a.div),KIP.Events.CSSChange&&a.dispatchEvent&&a.dispatchEvent(KIP.Events.CSSChange),c=" "+a.getAttribute("class")+" ",d=c.length,c=c.replace(" "+b+" "," "),c.length!==d&&a.setAttribute("class",KIP.Functions.Trim(c)))};KIP.Functions.HasCSSClass=function(a,b){if(a)return a.Draw&&(a=a.div),-1===(" "+a.getAttribute("class")+" ").indexOf(" "+b+" ")?!1:!0};
...
KIP.Functions.GlobalOffsets=function(a,b){return{left:KIP.Functions.GlobalOffsetLeft(a,b),top:KIP.Functions.GlobalOffsetTop(a,b)}};KIP.Functions.auxGlobalOffset=function(a,b,c){for(var d=0;a&&a!==c;)a[b]&&(d+=a[b]),a=a.offsetParent;return d};KIP.Functions.FindCommonParent=function(a,b){var c,d;if(a&&b)for(c=a,d=b;c;){for(;d;){if(c===d)return c;d=d.parentNode}c=c.parentNode;d=b}};
...
KIP.Functions.AddRow=function(a,b,c,d){var e,f;c||0===c||(c=-1);d||0===d||(d=b.length);if(a&&a.insertRow){a=a.insertRow(c);for(e=0;e<d;e+=1)c=a.insertCell(-1),f=b[e]||"",this.ProcessCellContents(f,c);return a}};KIP.Functions.CombineObjects=function(a,b,c){var d,e,f;d={};f=function(a,b){for(var d in a)a.hasOwnProperty(d)&&(c&&"object"===typeof a[d]?(e={},e.prototype=Object.create(a[d].prototype),e=KIP.Functions.CombineObjects(e,a[d]),b[d]=e):b[d]=a[d])};f(a,d);f(b,d);return d};
KIP.Functions.ReconcileOptions=function(a,b){var c,d;a||(a={});for(c in b)b.hasOwnProperty(c)&&(d=a[c],void 0===d||null===d)&&(a[c]=b[c]);return a};KIP.Functions.AddUnselectableClass=function(){KIP.Functions.CreateCSSClass(".unselectable",{"user-select":"none","-moz-user-select":"none","-webkit-user-select":"none","khtml-user-select":"none","o-user-select":"none"})};KIP.Functions.DateDiff=function(a,b,c,d,e){d||(a.setHours(0),a.setMilliseconds(0),a.setMinutes(0),a.setSeconds(0),b.setHours(0),b.setMilliseconds(0),b.setMinutes(0),b.setSeconds(0));a=a>b||c?a-b:b-a;d||(a=Math.floor(a/864E5));e&&(a+=864E5*(0>a?-1:1));return a};KIP.Functions.GetToday=function(a){var b;b=new Date;if(a)return b;b.setHours(0);b.setMilliseconds(0);b.setMinutes(0);b.setSeconds(0);return b};
...
KIP.Objects.Collection.prototype.RemoveElement=function(a,b){var c,d,e;b||0===b||(b=this.GetElementIdx(a));e=this.data.splice(b,1);delete this.backData[a];for(c in this.backData)this.backData.hasOwnProperty(c)&&(d=this.backData[c],d>b&&--this.backData[c]);for(c=this.sortedData.length-1;0<=c;--c)this.sortedData[c].key===a&&this.sortedData.splice(c,1);return{key:a,idx:b,value:e}};
KIP.Objects.Collection.prototype.RemoveElementAtIndex=function(a){var b;b=this.GetElementKey(a);return this.RemoveElement(b,a)};KIP.Objects.Collection.prototype.GetElement=function(a,b){b||0===b||(b=this.GetElementIdx(a));return!b&&0!==b||!this.data[b]&&0!==this.data[b]?null:this.data[b]};KIP.Objects.Collection.prototype.GetElementByIdx=function(a){var b=this.GetElementKey(a);return this.GetElement(b,a)};KIP.Objects.Collection.prototype.GetElementIdx=function(a){return this.backData[a]};
KIP.Objects.Collection.prototype.GetElementKey=function(a){var b=this.data[a];return b||0===b?this.data[a].key:null};KIP.Objects.Collection.prototype.Sort=function(a){this.data=this.data.sort(a);this.ReassignBackData();return this.data};KIP.Objects.Collection.prototype.ReassignBackData=function(){var a,b;for(a=0;a<this.data.length;a+=1)b=this.data[a].key,this.backData[b]=a};
KIP.Objects.Collection.prototype.MergeCollection=function(a,b){var c,d,e;for(d=0;d<a.data.length;d+=1)c=a.data[d].key,c in this.backData?b||(this.data[this.backData[c]]=a.data[d]):(e=this.data.push(a.data[d]),--e,this.backData[c]=e)};KIP.Objects.Collection.prototype.Clear=function(){this.data=[];this.backData={}};KIP.Objects.Collection.prototype.GetNextIndex=function(){return this.data.length};
KIP.Objects.Collection.prototype.DoesElementExist=function(a){return(a=this.backData[a])||0===a?!!this.data[a]:!1};KIP.Objects.Collection.prototype.Sort=function(a){var b;b=this.data.slice();return this.sortedData=b=b.sort(function(b,d){return a(b.value,d.value)})};KIP.Objects.Collection.prototype.GetSortedData=function(){return this.sortedData?this.sortedData.slice():this.data.slice()};KIP.Objects.Collection.prototype.HasNext=function(){return this.loopIdx<this.data.length-1};
KIP.Objects.Collection.prototype.Next=function(){this.loopIdx++;return this.loopIdx>=this.data.length?null:this.sortedData?this.sortedData[this.loopIdx]:this.data[this.loopIdx]};KIP.Objects.Collection.prototype.StartLoop=function(){this.ResetLoop()};KIP.Objects.Collection.prototype.ResetLoop=function(){this.loopIdx=-1};KIP.Functions.AJAXRequest=function(a,b,c,d,e){var f,g,h;f=!1;try{f=new XMLHttpRequest}catch(k){try{f=new ActiveXObject("Msxml2.XMLHTTP")}catch(l){try{f=new ActiveXObject("Microsoft.XMLHTTP")}catch(m){return!1}}}if(!f)return!1;"function"!==typeof c&&(c=function(){});"function"!==typeof d&&(d=function(){});h="";if("string"!==typeof e){for(g in e)e.hasOwnProperty(g)&&(0<h.length&&(h+="&"),h+=escape(g)+"="+escape(e[g]));e=h}f.onreadystatechange=function(){if(4===f.readyState)return 200===f.status?c(f.responseText):
...
KIP.Functions.GetAngle=function(a,b){var c,d,e,f;c=b.x-a.x;d=b.y-a.y;if(0===c)return 0>d?270:90;if(0===d)return 0>c?180:0;e=0>c?Math.PI:0;f=Math.atan(Math.abs(d)/Math.abs(c));return 180/Math.PI*(f*(0<c*d?1:-1)+e)};KIP.Functions.DegreesToRadians=function(a){return Math.PI*a/180};KIP.Functions.IsPointContained=function(a,b){if(b.bottom||b.top||b.left||b.right){if(a.x<b.left||a.x>b.right||a.y<b.top||a.y>b.bottom)return!1}else if(a.x<b.x||a.x>b.x+b.width||a.y<b.y||a.y>b.y+b.height)return!1;return!0};
KIP.Functions.IsWithin=function(a,b,c,d){return d?a<c&&a>b:a<=c&&a>=b};KIP.Functions.IsRectContained=function(a,b,c){return KIP.Functions.IsPointContained(a[0],b)&&KIP.Functions.IsPointContained(a[2],b)&&(!c||KIP.Functions.IsPointContained(a[1],b)&&KIP.Functions.IsPointContained(a[3],b))?!0:!1};KIP.Functions.IsElementContained=function(a,b){};
KIP.Functions.DoElementsOverlap=function(a,b){var c,d;c=a.getBoundingClientRect();d=b.getBoundingClientRect();return c.left>d.left&&c.left<d.width+d.left||d.left>c.left&&d.left<c.width+c.left||c.top>d.top&&c.top<d.height+d.top||d.top>c.top&&d.top<c.height+c.top?!0:!1};KIP.Objects.Drawable=function(a,b,c){this.div=KIP.Functions.CreateSimpleElement(a,b,c);this.children=[];this.elderSiblings=[];this.youngerSiblings=[];this.style=this.div.style};KIP.Objects.Drawable.prototype.AppendChild=function(a,b,c){this.children||(this.children=[]);c||0===c||(c=this.children.length);b=b||this.div;this.children.splice(c,0,{child:a,parent:b})};KIP.Objects.Drawable.prototype.AddSibling=function(a,b){b?this.elderSiblings.push(a):this.youngerSiblings.push(a)};
KIP.Objects.Drawable.prototype.RemoveSibling=function(a){return a&&this.elderSiblings&&this.youngerSiblings?!this.RemoveElem(a,this.elderSiblings)&&this.RemoveElem(a,this.youngerSiblings)?a:!1:!1};KIP.Objects.Drawable.prototype.RemoveElementByIdx=function(a,b){var c;if(0>a||a>b.length)return!1;c=b[a];b.splice(a,1);c.parentNode&&c.parentNode.removeChild(c);c.Draw&&c.Erase()};KIP.Objects.Drawable.prototype.RemoveElem=function(a,b){var c;for(c=0;c<b.length;c+=1)if(b[c]===a&&this.RemoveElementdByIdx(c))return a};
KIP.Objects.Drawable.prototype.RemoveChild=function(a){return a&&this.children?this.RemoveElem(a,this.children)?a:!1:!1};KIP.Objects.Drawable.prototype.RemoveChildByIdx=function(a){return this.RemoveElementByIdx(a,this.children)};KIP.Objects.Drawable.prototype.RemoveSiblingByIdx=function(a,b){return b?this.RemoveElementByIdx(a,this.elderSiblings):this.RemoveElementByIdx(a,this.youngerSiblings)};
KIP.Objects.Drawable.prototype.Draw=function(a,b,c){var d;if(this.div){this.parent=a||this.parent;this.Refresh();if(this.elderSiblings&&0<this.elderSiblings.length)for(a=0;a<this.elderSiblings.length;a+=1)d=this.elderSiblings[a],d.parentNode&&!b&&d.parentNode.removeChild(d),this.parent.appendChild(d);this.div.parentNode&&!b&&(c||(c=this.div.nextSibling),this.div.parentNode.removeChild(this.div));c?this.parent.insertBefore(this.div,c):this.parent.appendChild(this.div);if(this.youngerSiblings&&0<this.youngerSiblings.length)for(a=
0;a<this.youngerSiblings.length;a+=1)d=this.youngerSiblings[a],d.parentNode&&!b&&d.parentNode.removeChild(d),this.parent.appendChild(d);this.BeforeDrawChildren();if(this.children){for(a=0;a<this.children.length;a+=1)c=this.children[a],c.child&&(c.child.Draw?c.child.Draw(c.parent):(c.parentNode&&!b&&c.parentNode.removeChild(c),c.parent.appendChild(c.child)));this.AfterDrawChildren()}}};KIP.Objects.Drawable.prototype.Erase=function(){this.div.parentNode&&this.div.parentNode.removeChild(this.div)};
KIP.Objects.Drawable.prototype.Refresh=function(){};KIP.Objects.Drawable.prototype.BeforeDrawChildren=function(){};KIP.Objects.Drawable.prototype.AfterDrawChildren=function(){};KIP.Objects.Editable=function(a,b,c,d,e){this.id=a;this.type=b||"text";this.content=c;this.validate=d;this.update=e;this.is_modifying=!1;KIP.Objects.Drawable.call(this,this.id,"editable",this.content);this.CreateElements();this.AddListeners()};KIP.Objects.Editable.prototype=Object.create(KIP.Objects.Drawable.prototype);
...
KIP.Objects.Editable.prototype.Save=function(){var a;a=this.inputDiv.value;this.div.removeChild(this.inputDiv);this.is_modifying=!1;this.validate&&!this.validate(a)?(this.inputDiv.value=this.content,this.div.innerHTML=this.content):(this.content=a,this.div.innerHTML=a,this.update&&this.update(this.content,this))};KIP.Objects.SVGDrawable=function(a,b,c){this.div=KIP.Functions.CreateSVG(a,"","","","",c&&c.aspect);this.elements=[];this.elementsByID=[];this.min_y=this.min_x=1E6;this.viewH=this.viewW=this.viewY=this.viewX=this.max_y=this.max_x=0;this.gutter=1;this.cur_ID=0;this.lineProperty={};this.fillProperty={};this.fontProperty={};this.autoResize=!0;this.zoomAmt=.08;if(!b){this.div.style.cursor="-webkit-grab";var d=this;this.options=c||{};void 0===this.options.zoomX&&(this.options.zoomX=!b);void 0===this.options.zoomY&&
(this.options.zoomY=!b);void 0===this.options.panX&&(this.options.panX=!b);void 0===this.options.panY&&(this.options.panY=!b);this.div.addEventListener("wheel",function(a){a=a.deltaY;a=0<a?d.zoomAmt:-1*d.zoomAmt;d.Zoom(a)});this.div.addEventListener("mousedown",function(a){d.isPanning=!0;d.panX=a.clientX;d.panY=a.clientY;d.div.style.cursor="-webkit-grabbing"});window.addEventListener("mousemove",function(a){var b,c;d.isPanning&&(0>=a.x||a.x>=window.innerWidth-1?(d.isPanning=!1,d.div.style.cursor=
"-webkit-grab"):0>=a.y||a.y>=window.innerHeight-1?(d.isPanning=!1,d.div.style.cursor="-webkit-grab"):(b=a.clientX-d.panX,c=a.clientY-d.panY,d.div.style.cursor="-webkit-grabbing",d.panX=a.clientX,d.panY=a.clientY,b=(1+-1*d.viewW*b)/d.w,c=(2+-1*d.viewH*c)/d.h,d.Pan(b,c)))});window.addEventListener("mouseup",function(a){d.isPanning=!1;d.div.style.cursor="-webkit-grab"})}};KIP.Objects.SVGDrawable.prototype=Object.create(KIP.Objects.Drawable.prototype);
KIP.Objects.SVGDrawable.prototype.CalculateView=function(a){this.viewX=this.min_x;this.viewY=this.min_y;this.viewW=this.max_x-this.min_x;this.viewH=this.max_y-this.min_y;return this.CreateView(a)};KIP.Objects.SVGDrawable.prototype.CreateView=function(a){var b;this.viewW=0>this.viewW?1:this.viewW;this.viewH=0>this.viewH?1:this.viewH;b=this.viewX+" "+this.viewY+" "+this.viewW+" "+this.viewH;a&&this.div.setAttribute("viewBox",b);return b};
KIP.Objects.SVGDrawable.prototype.AddRectangle=function(a,b,c,d,e,f){if(!(!a&&0!==a||!b&&0!==b||0>c||!c&&0!==c||0>d||!d&&0!==d))return this.autoResize&&this.UpdateView(a,b,c,d),e||(e={}),e.x=a,e.y=b,e.height=d,e.width=c,this.AddChild("rect",e,f)};
...
KIP.Globals.CreatedCtxMenuStyles=!0)};KIP.Objects.EventHandler=function(){};KIP.Objects.EventHandler.prototype.AddListener=function(){};KIP.Objects.Flow=function(a,b){};KIP.Objects.Form=function(a,b,c,d,e,f){this.id=a;this.title=b||"Options";this.tables=[];this.btns=c||[];this.saveCb=d||function(){};this.fields=new KIP.Objects.Collection;this.embedded=f||!1;this.showOverlay=!e;this.standardStyle=!0;this.themeColor="rgba(0,135,230,1)";KIP.Objects.Drawable.call(this,this.id,"form");this.CreateElements()};KIP.Objects.Form.prototype=Object.create(KIP.Objects.Drawable.prototype);
...
KIP.Objects.Form.prototype.CreateOverlay=function(){var a=this;this.showOverlay&&(this.overlay=KIP.Functions.CreateSimpleElement("","overlay"),this.overlay.addEventListener("click",function(){a.CloseForm()}),this.AddSibling(this.overlay))};
KIP.Objects.Form.prototype.CreateBtnBar=function(a){var b,c,d;this.btnBar=KIP.Functions.CreateSimpleElement("","btnBar");d=this;b=function(a){var b;b=KIP.Functions.CreateSimpleElement(d.id+"-"+a.id,"btn "+a.cls,a.lbl);a.click&&b.addEventListener("click",a.click);a.color&&(b.style.backgroundColor=a.color);return b};for(c=0;c<this.btns.length;c+=1)a=this.btns[c],"OK"!==a.lbl&&"Accept"!==a.lbl&&"Save"!==a.lbl||a.click||(a.click=function(){d.Save();d.CloseForm()}),"Apply"!==a.lbl&&"Add"!==a.lbl||a.click||
(a.click=function(){d.Save()}),"Cancel"!==a.lbl||a.click||(a.click=function(){d.CloseForm()}),a=b(a),this.btnBar.appendChild(a);this.AppendChild(this.btnBar)};KIP.Objects.Form.prototype.CreateElements=function(){this.showOverlay&&!this.embedded&&(this.CreateOverlay(),this.CreateTitleBar());this.CreateContent();this.CreateBtnBar()};KIP.Objects.Form.prototype.CreateContent=function(){var a;a=KIP.Functions.CreateSimpleElement(this.id+"-content","content");this.AppendChild(a);this.content=a};
KIP.Objects.Form.prototype.CreateSection=function(a,b,c){var d,e,f;e=KIP.Functions.CreateSimpleElement(a,"section");b&&(f=KIP.Functions.CreateSimpleElement("","secHeader",b));b=this.tables.length;c=c||1;d=KIP.Functions.CreateTable(a+"-table","columnContainer","",0,c);this.tables[b]={table:d,data:[],colNum:c,rowNum:0,id:a};f&&e.appendChild(f);e.appendChild(d);this.content.appendChild(e);return this.currentSection=b};
KIP.Objects.Form.prototype.AddField=function(a,b,c,d,e,f){e||0===e||(e=c);d&&this.AddElement(d,e);this.AddElement(b,c);b&&this.fields.AddElement(a,{elem:b,id:a,resetValue:f});this.div.parentNode&&this.Draw();return b};KIP.Objects.Form.prototype.AddHeader=function(a,b){};
KIP.Objects.Form.prototype.AddElement=function(a,b){var c,d,e,f,g,h,k;b?(b.table||0===b.table||(b.table=this.currentSection),b.table||0===b.table||(b.table=this.tables.length-1),b.col=b.col||0):b={table:this.currentSection||this.tables.length-1,col:0};d=b.table;e=b.col;if(0>d||!this.tables[d])return!1;f=this.tables[d].rowNum;g=this.tables[d].colNum;h=this.tables[d].data;0<f&&h[f-1]&&(c=h[f-1],c.children[e]&&c.children[e].innerHTML||(KIP.Functions.ProcessCellContents(a,c.children[e]),k=!0));k||(c=
[],c[e]=a,c=KIP.Functions.AddRow(this.tables[d].table,c,"",g),f+=1,h.push(c));this.tables[d].rowNum=f;this.tables[d].data=h};KIP.Objects.Form.prototype.AddTextInput=function(a,b,c,d,e){return this.AddInput(a,"text",b,[{key:"placeholder",val:d}],e,"",c,c)};
KIP.Objects.Form.prototype.AddSelectInput=function(a,b,c,d,e,f){var g,h,k,l;h=[];for(k=0;k<b.length;k+=1)l=b[k],l=KIP.Functions.CreateElement({type:"option",id:l.id||a+"-opt"+k,attr:{value:l.value,label:l.lbl||l.value}}),h.push(l);b=KIP.Functions.CreateElement({type:"select",children:h,id:a,attr:{value:c}});e&&(g=KIP.Functions.CreateSimpleElement(a+"lbl","lbl",e));return this.AddField(a,b,d,g,f,c)};
...
KIP.Objects.Form.prototype.AddInput=function(a,b,c,d,e,f,g,h){var k;"object"===typeof a&&(b=a.type,c=a.value,d=a.attr,e=a.lbl,f=a.cls,g=a.position,h=a.lblPosition,a=a.id);d||(d={});d.type=b;"checkbox"===b||"radio"===b?d.checked=c:d.value=c;b=KIP.Functions.CreateElement({type:"input",cls:f,id:a,attr:d});e&&(k=KIP.Functions.CreateSimpleElement(a+"lbl","lbl",e));return this.AddField(a,b,g,k,h,c)};KIP.Objects.Form.prototype.AddOrderedList=function(a,b){};
KIP.Objects.Form.prototype.UpdateFieldValue=function(a,b){var c,d;if(c=this.fields.GetElement(a))c=c.value.elem,d=c.getAttribute(c,"type"),"checkbox"===d||"radio"===d?c.checked=b:c.value=b};KIP.Objects.Form.prototype.UpdateFieldAttribute=function(a,b,c){if(a=this.fields.GetElement(a))a=a.value.elem,a.setAttribute(b,c)};
KIP.Objects.Form.prototype.Reset=function(){var a,b,c;for(a=0;a<this.fields.Length();a+=1)b=this.fields.GetElement("",a).value,c=b.elem.getAttribute("type"),"checkbox"===c||"radio"===c?b.elem.checked=b.resetValue:b.elem.value=b.resetValue};KIP.Objects.Form.prototype.Save=function(){var a,b,c,d;c={};for(a=0;a<this.fields.Length();a+=1)b=this.fields.GetElement("",a).value,d=b.elem.getAttribute("type"),c[b.id]="checkbox"===d||"radio"===d?b.elem.checked:b.elem.value;this.saveCb&&this.saveCb(c)};
KIP.Objects.Form.prototype.CloseForm=function(){this.overlay&&this.overlay.parentNode&&this.overlay.parentNode.removeChild(this.overlay);this.div.parentNode&&this.div.parentNode.removeChild(this.div)};KIP.Objects.Form.prototype.AfterDrawChildren=function(){this.standardStyle&&!this.stylesCreated&&(this.ApplyStandardStyles(),this.stylesCreated=!0)};
KIP.Objects.Form.prototype.ApplyStandardStyles=function(){var a,b,c,d,e;this.embedded?(c="100%",d=b="0",e="100%"):(c="40%",b="30%",d="15%",e="80%");a=KIP.Functions.GetComputedStyle(this.parent,"position");"static"===a&&(a="relative");this.parent.style.position=a;KIP.Functions.CreateCSSClass(".overlay",{position:"fixed",left:0,top:0,width:"100%",height:"100%","background-color":"rgba(0,0,0,0.7)","z-index":"1"});KIP.Functions.CreateCSSClass(".form",{left:b,top:d,"background-color":"#FFF","box-shadow":"1px 1px 13px 4px rgba(0,0,0,.2);",
"font-family":"Segoe UI, Calibri, sans","z-index":"2",position:"absolute",display:"block","max-width":e,padding:"10px",width:c,"box-sizing":"border-box"});a={"background-color":"rgba(0,0,0,.1)",border:"1px solid rgba(0,0,0,.25)","font-family":"Segoe UI, Calibri, sans"};KIP.Functions.CreateCSSClass(".form input",a);a={width:"250px",outline:"none"};KIP.Functions.CreateCSSClass(".form input[type=text]",a);a={width:"calc(100% - 10px)","text-align":"center","background-color":this.themeColor,color:"#FFF",
padding:"5px","font-size":"20px",position:"absolute",top:"-30px",left:"0px"};KIP.Functions.CreateCSSClass(".form .titleBar",a);a={"float":"right",display:"inline-block",opacity:"0.7","font-size":"15px","padding-top":"2px","padding-right":"5px"};KIP.Functions.CreateCSSClass(".form .titleBar .close",a);a={opacity:"1",cursor:"pointer"};KIP.Functions.CreateCSSClass(".form .titleBar .close:hover",a);a={width:"100%",display:"flex","flex-direction":"row","justify-content":"flex-end","font-size":"20px"};
KIP.Functions.CreateCSSClass(".form .btnBar",a);a={padding:"5px","box-shadow":"1px 1px 1px 1px rgba(0,0,0,.2)","border-radius":"3px","font-size":"15px",opacity:"0.7",margin:"5px"};KIP.Functions.CreateCSSClass(".form .btnBar .btn",a);a={opacity:"1",cursor:"pointer"};KIP.Functions.CreateCSSClass(".form .btnBar .btn:hover",a);KIP.Functions.CreateCSSClass(".form .lbl",{color:"#666",display:"inline-block","text-align":"right","padding-left":"5px","padding-right":"5px"});KIP.Functions.CreateCSSClass(".form .secHeader",
{color:this.themeColor,"font-weight":"bold","font-size":"22px","margin-bottom":"10px","margin-top":"10px"});b={display:"table",width:"100%"};KIP.Functions.CreateCSSClass(".form .columnContainer",b);b={display:"table-cell"};KIP.Functions.CreateCSSClass(".form .column",b);for(a=0;a<this.tables.length;a+=1)c=this.tables[a],b=100/c.colNum,b={width:b+"%"},KIP.Functions.CreateCSSClass(".form #"+c.id+" .column",b)};KIP.Constants.GraphTypeEnum={Pie:0,Bar:1,Circle:2,Tier:3,Line:4,Trend:5,Segment:6};KIP.Objects.Graph=function(a,b){this.id=a;this.data=[];this.dataListeners=[];this.type=b;this.sortedData=[];this.units={};this.htmlLbls=[];this.elems=[];this.svg=new KIP.Objects.SVGDrawable(a+"|graph",!0);KIP.Objects.Drawable.call(this,a);this.AppendChild(this.svg)};KIP.Objects.Graph.prototype=Object.create(KIP.Objects.Drawable.prototype);
...
KIP.Objects.ProjectWindow.prototype.Resize=function(){var a=this.width/this.height;this.viewH=30*this.rowHeight;this.viewW=40*this.unitWidth*a;this.viewY=this.viewX=0;return this.CreateView()};KIP.Objects.ProjectWindow.prototype.ConvertToProjectPoint=function(a,b,c){b=b||this.start;a=this.showWeekends?KIP.Functions.DateDiff(a,b,!0,c):KIP.Functions.BusinessDateDiff(a,b,!0,c);c&&(a/=864E5);return a};
KIP.Objects.ProjectWindow.prototype.RevertFromProjectPoint=function(a){var b;b=new Date(this.start);this.showWeekends||(a+=2*Math.floor((a+this.start.getDay())/5)+1);b.setDate(b.getDate()+a);return b};KIP.Objects.ProjectWindow.prototype.AddGrouper=function(a){};KIP.Objects.ProjectWindow.prototype.AddSpacer=function(){this.rows.push("spacer");this.items.push("spacer")};
KIP.Objects.ProjectWindow.prototype.CreateExpandedInfo=function(a){var b,c;c={TopSegments:!0,BottomSegments:!0,Events:!0,Design:!0,ganttItem:!0,svgElem:!0,sidebarElem:!0,groupName:!0};b=KIP.Functions.CreateSimpleElement("","additionalInfo");b.innerHTML=this.expandedInfoCB?this.expandedInfoCB(a):this.WriteArray(a,"<div class='additionalInfoLine'>","</div>",c);return b};
...
KIP.Objects.ProjectWindow.prototype.AddItem=function(a,b,c,d,e,f){var g,h,k;a.getYear||(a=new Date(a));b.getYear||(b=new Date(b));h=this.ConvertToProjectPoint(a);k=this.ConvertToProjectPoint(b);g=this.items.length;f=this.GetRow(h,k);e=this.items[g]={grp:this.CreateGroup("item"+g,this.itemGrp),lbl:c,row:f,start:a,end:b,x:h*this.unitWidth,y:f*this.rowHeight*this.rowSpace,width:(k-h)*this.unitWidth,id:g,eventGrp:this.CreateGroup(g+"|events",this.eventGrp),addl:e,addlInfoExpanded:this.CreateExpandedInfo(e)};
for(g=0;g<d.length;g+=1)this.CreateSegments(d[g],e,h,k,e.y,g);e.ctx=this.AddContextMenu(e);this.fillProperty.color="#000";this.fillProperty.opacity=.8;this.fontProperty.size=2*this.rowHeight/3;e.text=this.AddText("",c+"   "+KIP.Functions.ShortDate(a)+" - "+KIP.Functions.ShortDate(b),this.unitWidth/2,-1,"","",e.grp);this.fillProperty.opacity=1;this.showTitles||e.text.parentNode.removeChild(e.text);this.rows[f]||(this.rows[f]=[]);this.rows[f].push(e);return e};
...
KIP.Objects.ProjectWindow.prototype.CreateSegments=function(a,b,c,d,e,f){var g,h,k,l,m;h=c;m=!0;for(g=0;g<a.length;g+=1)a[g]&&(l=a[g].end,l.getYear||(l=new Date(l)),k=this.ConvertToProjectPoint(l),a[g].start&&(l=a[g].start,l.getYear||(l=new Date(l)),h=this.ConvertToProjectPoint(l)),m?m=!1:h+=.5,k>=h?this.CreateSegment(b,{x:h,y:e},k,a[g],g,f,b):console.log("\nError in segment creation\nStart: "+h+" End: "+k),h=k);this.disableFill||h===d||this.CreateSegment(b,{x:m?c:h+.5,y:e},d,{},-1,f,b)};
KIP.Objects.ProjectWindow.prototype.CreateSegment=function(a,b,c,d,e,f,g){var h,k;h=b.y;k=this.rowHeight*this.barPercentages[f];if(0<f){for(--f;0<=f;--f)h+=this.rowHeight*this.barPercentages[f]+this.barGap*this.rowHeight;h+=this.barGap*this.rowHeight}f=b.x*this.unitWidth;b=(c-b.x)*this.unitWidth+.5*this.unitWidth;if(0>b||isNaN(b))console.log("Err: improper width for segment");else return this.SetSegmentStyle(d,e),e=this.AddRectangle(f,h,b,k,"",a.grp),d.lbl&&(b=d.lbl,d.type&&(b+="<br>["+d.type+" on "+
d.end+"]"),this.showTitles||(b+="<br><br>"+g.lbl+" ("+KIP.Functions.ShortDate(g.start)+" - "+KIP.Functions.ShortDate(g.end)+")"),this.AddTextBubble(b,e,a,"","","",h+6*k-a.y)),e};KIP.Objects.ProjectWindow.prototype.SetSegmentStyle=function(a,b){this.segmentColors[b]||(this.segmentColors[b]=KIP.Functions.GenerateColor(b,KIP.Constants.HSLPieceEnum.Hue));this.fillProperty.type="solid";this.fillProperty.color=this.segmentColors[b]};
...
KIP.Objects.ProjectWindow.prototype.AddTextBubble=function(a,b,c,d,e,f){var g,h;if(b&&(this.textDiv.parentNode||this.parent.appendChild(this.textDiv),!this.options.noHoverBubbles))return g=KIP.Functions.CreateSimpleElement("txt."+a,"textBubble",a),g.style.position="absolute",g.style.backgroundColor=this.bubbleColor,g.style.color=this.textColor,g.style.fontFamily="Segoe UI Light",g.style.padding="5px",g.style.borderRadius="5px",g.style.fontSize="12px",g.style.boxShadow="1px 1px 8px 2px rgba(0,0,0,.1)",
this.textDiv.appendChild(g),h=this,b.addEventListener("mouseover",function(a){var c,d;KIP.Functions.HasCSSClass(g,"hidden")&&(h.lastBubble&&KIP.Functions.AddCSSClass(h.lastBubble,"hidden"),d=b.getBoundingClientRect(),a=a.x,c=Math.round(d.top+d.height),KIP.Functions.RemoveCSSClass(g,"hidden"),d=g.getBoundingClientRect(),0>a?a=0:a+d.width>window.innerWidth&&(a=window.innerWidth-d.width),0>c?c=0:c+d.height>window.innerHeight&&(c=window.innerHeight-d.height),g.style.left=a+"px",g.style.top=c+"px",h.lastBubble=
g,b.style.opacity=1)}),b.addEventListener("mouseout",function(a){KIP.Functions.AddCSSClass(g,"hidden");b.style.opacity=f}),b.addEventListener("mousemove",function(a){KIP.Functions.HasCSSClass(g,"hidden")||(g.style.left=a.x+"px")}),KIP.Functions.AddCSSClass(g,"hidden"),g};
KIP.Objects.ProjectWindow.prototype.CreateGuidelines=function(){var a,b,c,d,e,f,g,h,k,l;a=this.CalculateScreenCoordinates(this.viewX,this.viewY);0===this.CalculateScreenCoordinates(this.viewX+this.unitWidth/15,this.viewY).x-a.x&&(b=!0);this.viewW>200*this.unitWidth&&(b=!0);this.CreateGuideHeaders(b);for(b=this.lines.length-1;0<=b;--b)this.lines[b]&&this.lines[b].parentNode&&this.lineGrp.removeChild(this.lines[b]);this.lines=[];a=this.viewW/this.unitWidth;e=new Date;e.getDay();this.ConvertToProjectPoint(e);
this.fillProperty.type="solid";this.lineProperty.type="none";this.lineProperty.color="rgba(0,0,0,0)";for(b=this.lineProperty.width=0;b<a;b+=1)if(d=this.viewX+(this.unitWidth-this.viewX%this.unitWidth)+b*this.unitWidth,f=this.RevertFromProjectPoint(d/this.unitWidth),h=KIP.Functions.ShortDate(f),c=f.getDay(),g="",this.importantDates[h]){g=this.unitWidth/this.importantDates[h].length;for(l=0;l<this.importantDates[h].length;l+=1)this.fillProperty.color=this.importantDates[h][l].color,0===KIP.Functions.DateDiff(f,
e)&&(this.lineProperty.width=g/8,this.lineProperty.color="#8AE",this.lineProperty.type="solid"),k=this.importantDates[h][l].textColor,c=this.AddRectangle(d+l*g,this.viewY,g,this.viewH,"",this.lineGrp),this.lines.push(c);this.lineProperty.type="none";this.lineProperty.width=0;this.lineProperty.color="rgba(0,0,0,0)"}else 0===KIP.Functions.DateDiff(f,e)?this.fillProperty.color="#8AE":!this.showWeekends||0!==c&&6!==c?(this.showWeekends||1!==c?(this.fillProperty.color="rgba(255,255,255,.4)",this.lineProperty.color=
"rgba(220,220,220,.4)"):(this.fillProperty.color="rgba(255,255,255,.4)",this.lineProperty.color="rgba(100,100,100,.3)"),this.lineProperty.type="solid",this.lineProperty.width=this.unitWidth/20):this.fillProperty.color="rgba(0,0,0,.15)",c=this.AddRectangle(d,this.viewY,this.unitWidth,this.viewH,{"class":"projectCol",id:"col"+h},this.lineGrp),this.lines.push(c),this.lineProperty.type="none",this.lineProperty.color="rgba(0,0,0,0)",this.lineProperty.width=0,g&&(this.fillProperty.color=k,this.fontProperty.size=
2*this.unitWidth/3,g=this.AddText(c,g,.5*this.unitWidth,3*this.rowHeight,"",{x:.5,y:.5},this.lineGrp),d=this.MeasureElem(g),g.setAttribute("y",+g.getAttribute("y")+d.width/2+this.rowHeight),this.RotateElement(g,-90),this.lines.push(g))};
KIP.Objects.ProjectWindow.prototype.CreateGuideHeaders=function(a){var b,c,d,e,f,g,h;!this.textDiv.parentNode&&this.parent&&this.parent.appendChild(this.textDiv);for(c=this.headers.length-1;0<=c;--c)this.headers[c]&&this.headers[c].parentNode&&this.headers[c].parentNode.removeChild(this.headers[c]);this.headers=[];f={};h=this.CalculateSVGHeight(this.maxHeaderHeight);this.fillProperty.type="solid";this.fontProperty.size=h/3;this.fontProperty.family="Segoe UI Light,Calibri";this.fillProperty.opacity=
1;b=this.viewW/this.unitWidth;for(c=0;c<b;c+=1)e=this.viewX+(this.unitWidth-this.viewX%this.unitWidth)+(c-1)*this.unitWidth,d=this.RevertFromProjectPoint(e/this.unitWidth),g=d.getMonth()+"."+d.getYear(),f[g]?f[g].end=e:f[g]={name:KIP.Functions.GetMonthName(d,!0),start:e,month:d.getMonth(),year:d.getFullYear().toString()},a||(this.fillProperty.color="#FFF",this.headers.push(this.AddRectangle(e,this.viewY+h,this.unitWidth,h/2,"",this.headerGrp)),this.fillProperty.color="#68C",this.fontProperty.size=
4*this.unitWidth/5,this.headers.push(this.AddText("",d.getDate(),e+this.unitWidth/4,this.viewY+h,"",{x:0,y:0},this.headerGrp)));for(g in f)f.hasOwnProperty(g)&&(c=f[g],b=c.end-c.start+this.unitWidth,0>b||isNaN(b)||(this.fillProperty.color=this.monthColors[c.month],this.headers.push(this.AddRectangle(c.start,this.viewY,b,h,"",this.headerGrp)),a=KIP.Functions.CreateSimpleElement("","monthHeader",c.name.toUpperCase()+" "+c.year[2]+c.year[3],"","",this.textDiv),c=this.CalculateScreenCoordinates(c.start,
this.viewY),a.style.left=c.x+"px",a.style.top=c.y="px",a.style.width=b+"px",a.style.color="#FFF",a.style.position="absolute",this.headers.push(a)))};KIP.Objects.ProjectWindow.prototype.Zoom=function(a){this.expanded||(this.lastBubble&&KIP.Functions.AddCSSClass(this.lastBubble,"hidden"),KIP.Objects.SVGDrawable.prototype.Zoom.call(this,a),this.CreateGuidelines(),this.RefreshUI())};
KIP.Objects.ProjectWindow.prototype.Pan=function(a,b){this.expanded||(this.lastBubble&&KIP.Functions.AddCSSClass(this.lastBubble,"hidden"),KIP.Objects.SVGDrawable.prototype.Pan.call(this,a,b),this.CreateGuidelines(),this.RefreshUI(!0))};
...
KIP.Objects.ProjectWindow.prototype.ClearUI=function(){this.itemGrp.innerHTML="";this.eventGrp.innerHTML="";this.textDiv.innerHTML="";this.CreateGuideHeaders()};
...
KIP.Objects.ProjectWindow.prototype.RefreshUI=function(a){var b,c,d,e,f;this.rows=[];for(b=d=0;b<this.items.length;b+=1)this.rows.push(this.items[b]),"spacer"!==this.items[b]&&(c=void 0,this.items[b].row=b,this.showTitles?(this.items[b].text&&!this.items[b].text.parentNode&&this.items[b].grp.appendChild(this.items[b].text),c=this.MeasureElem(this.items[b].text),e=this.CalculateScreenCoordinates(this.items[b].x,0).x,f=this.CalculateScreenWidth(this.MeasureElem(this.items[b].grp).width)+e,0>e?(e=this.CalculateSVGCoordinates(0,
0).x,0<f?this.items[b].text.setAttribute("x",e):this.items[b].text.setAttribute("x",f)):this.items[b].text.setAttribute("x",this.items[b].x)):this.items[b].text&&this.items[b].text.parentNode&&this.items[b].text.parentNode.removeChild(this.items[b].text),this.itemHeaders[b]&&(this.headerDiv.appendChild(this.itemHeaders[b].div),c=this.CalculateScreenCoordinates(0,d+this.rowSpace+b*this.rowHeight*this.rowSpace-(c?c.height:0)).y,c+=this.div.getBoundingClientRect().top,this.itemHeaders[b].div.style.top=
c+"px",c=this.itemHeaders[b].div.getBoundingClientRect(),0<c.height&&(d+=this.CalculateSVGHeight(c.height)+1.5*this.rowSpace+(this.headerGap||0))),c=d+b*this.rowHeight*this.rowSpace,a||this.AdjustY(this.items[b],c,b));this.Draw();this.refreshNotify&&this.refreshNotify(a)};
KIP.Objects.ProjectWindow.prototype.AddItemHeader=function(a,b){var c;this.headerDiv.parentNode||this.parent.appendChild(this.headerDiv);c=KIP.Functions.CreateSimpleElement("header"+a,"header",b);this.itemHeaders[a]={div:c,lbl:b,key:a}};
KIP.Objects.ProjectWindow.prototype.AddImportantDate=function(a,b,c,d,e,f){var g,h,k,l,m=this;l=function(a,b,c,d,e){e=KIP.Functions.ShortDate(a);m.importantDates[e]||(m.importantDates[e]=[]);m.importantDates[e].push({date:new Date(a),lbl:b,color:c||"#C30",textColor:d||"#FFF",category:f,shortDate:e})};a.getFullYear||(a=new Date(a));e&&!e.getFullYear&&(e=new Date(e));g=0;h=1;e&&(g=KIP.Functions.DateDiff(e,a),h=0>g?-1:1,g=Math.abs(g));if(a&&a.getFullYear){k=new Date(a);for(e=0;e<=g;e+=h)a=k,l(a,b,c,
d,f),a=KIP.Functions.AddToDate(k,{days:1});this.CreateGuidelines();this.Draw()}};
...
KIP.Objects.ProjectWindow.prototype.AddImportantDateCategory=function(a){var b;for(b=0;b<this.impDateCategories.length;b+=1)if(this.impDateCategories[b]===a)return!1;b=this.impDateCategories.length;this.impDateCategories.push(a);if(!this.dateForm)return b;a=KIP.Functions.CreateElement({type:"Option",value:b,before_content:a});this.impDateCatSelector.appendChild(a);return b};
KIP.Objects.ProjectWindow.prototype.RemoveImportantDate=function(a,b){b?this.importantDates[a].splice(b,1):delete this.importantDates[a];this.CreateGuidelines();this.Draw()};KIP.Objects.ProjectWindow.prototype.Jump=function(a,b){this.viewX=a||this.viewX;this.viewY=b||this.viewY;this.view=this.CreateView();this.CreateGuidelines();this.CreateView(!0)};KIP.Objects.ProjectWindow.prototype.AfterDrawChildren=function(){!this.textDiv.parentNode&&this.parent&&this.parent.appendChild(this.textDiv)};KIP.Objects.Select=function(a){KIP.Objects.Drawable.call(this,a,"select");this.id=a;this.input=KIP.Functions.CreateElement({type:"input",cls:"select",id:"input"+a});this.data=[];this.dataDiv=KIP.Functions.CreateSimpleElement("data"+a,"dropdown");this.selectedData=-1;this.options=[];this.visible=[];this.keys={};this.visibleCnt=0;this.div.appendChild(this.input);this.div.appendChild(this.dataDiv);this.AddListeners()};KIP.Objects.Select.prototype=Object.create(KIP.Objects.Drawable.prototype);
...
KIP.Objects.Select.prototype.Validate=function(){var a;-1!==this.selectedData&&this.Select(this.data[this.selectedData]);if(1===this.visibleCnt)for(a=0;a<this.visible.length;a+=1)this.visible[a]&&this.Select(this.data[a])};KIP.Objects.Shield=function(a,b){this.id=a;this.type=b||"plain";this.addEntertainment=!0;this.options={animateSpeed:300};"trivia"===b&&(this.options.animateSpeed=3E3);KIP.Objects.Drawable.call(this,"shield"+a,"shield");this.div.addEventListener("click",function(a){a.stopPropagation();return!1});this.container=KIP.Functions.CreateSimpleElement("shield"+this.id+"|container","container");this.div.appendChild(this.container)};KIP.Objects.Shield.prototype=Object.create(KIP.Objects.Drawable.prototype);
KIP.Objects.Shield.prototype.Show=function(){var a;this.noStyles||this.addedStyles||(this.AddStyles(),this.addedStyles=!0);this.addEntertainment?this.AddEntertainment(this.entertainmentType):this.animateFunc&&(a=this.animateFunc,this.animate=window.setInterval(a,this.options.animateSpeed));this.Draw(document.body);this.showing=!0};KIP.Objects.Shield.prototype.Hide=function(){this.Erase();this.animate&&window.clearInterval(this.animate);this.showing=!1};
KIP.Objects.Shield.prototype.AddEntertainment=function(){var a,b,c,d,e;b=0;switch(this.type){case "trvia":a=KIP.Functions.CreateSimpleElement("","trivia");d=KIP.Functions.CreateSimpleElement("","header","","","",a);e=KIP.Functions.CreateSimpleElement("","text","","","",a);this.animateFunc=c=function(){b+=1;b%=this.trivia.length;d.innerHTML=this.trivia[b].header;e.innerHTML=this.trivia[b].text};break;case "game":break;default:a=KIP.Functions.CreateSimpleElement("","plain","Loading"),this.animateFunc=
c=function(){var c;b+=1;c="";switch(b%6){case 0:c="";break;case 1:c=".";break;case 2:c="..";break;case 3:case 4:case 5:c="..."}a.innerHTML="Loading"+c}}c&&(this.animate=window.setInterval(c,this.options.animateSpeed));this.container.appendChild(a);this.addEntertainment=!1};KIP.Objects.Shield.prototype.AddTrivia=function(a,b,c){this.trivia||(this.trivia=[]);this.trivia.push({header:a,text:b,timing:c||this.options.animateSpeed})};
...
KIP.Functions.IncludeKIP=function(a,b,c){var d,e,f,g;f=[];g=[];a||(a=KIP.Constants.Files.slice());b||(b=[]);for(d=a.length-1;0<=d;--d)e=a[d],b[e]||(KIP.Constants.DrawableDependents[e]?g.push(KIP.Constants.DropboxPath+e+".js"):f.push(KIP.Constants.DropboxPath+e+".js"));KIP.Functions.Include(f,function(){KIP.Functions.Include(g,c)})};KIP.Functions.CreateScriptElement=function(a,b){var c;c=document.createElement("script");c.setAttribute("src",a);b&&(c.onload=b);document.head.appendChild(c);return c};KIP.Objects.Tutorial=function(a){this.screens=[];this.elems={};this.currentInline=this.currentScreen=null;this.options=a||{};KIP.Functions.ReconcileOptions(this.options,{preferFullScreen:!0,useStandardStyles:!0});KIP.Objects.Drawable.call(this,"tutorial","tutorial");this.CreateElements()};KIP.Objects.Tutorial.prototype=Object.create(KIP.Objects.Drawable.prototype);
KIP.Objects.Tutorial.prototype.AddScreen=function(a,b,c){var d,e=this;c||0===c?this.screens[c]&&this.screens.splice(c,0,{}):c=this.screens.length;d=KIP.Functions.CreateSimpleElement("screen"+c,"screen btn","","","",this.elems.screens);d.addEventListener("click",function(){e.GotoScreen(c)});this.screens[c]={title:a,content:b,idx:c,hilites:[],btn:d};0!==c||this.shown||this.GotoScreen(0);return c};
KIP.Objects.Tutorial.prototype.AddHilitedElement=function(a,b,c){var d;d=this.screens[c];if(!d)return-1;d.hilites.push({elem:a,content:b});this.currentScreen===c&&this.GotoScreen(this.currentScreen);return d.hilites.length-1};KIP.Objects.Tutorial.prototype.Show=function(){this.AddStandardStyles();document.body.appendChild(this.div);KIP.Functions.AddCSSClass(this.div,"visible");this.shown=!0};
KIP.Objects.Tutorial.prototype.Hide=function(){var a=this;KIP.Functions.RemoveCSSClass(this.div,"visible");this.shown=!1;window.setTimeout(function(){document.body.removeChild(a.div)},200)};KIP.Objects.Tutorial.prototype.ShowInlineHelp=function(){};KIP.Objects.Tutorial.prototype.HideInlineHelp=function(){};KIP.Objects.Tutorial.prototype.NextScreen=function(){this.GotoScreen((this.currentScreen+1)%this.screens.length)};
KIP.Objects.Tutorial.prototype.PreviousScreen=function(){var a;a=this.currentScreen-1;0>a&&(a=this.screens.length-1);this.GotoScreen(a)};
KIP.Objects.Tutorial.prototype.GotoScreen=function(a){var b,c,d,e,f,g;b=this.screens[a];this.elems.title.innerHTML=b.title;"string"===typeof b.content?this.elems.description.innerHTML=b.content:(this.elems.description.innerHTML="",this.elems.description.appendChild(b.content));(this.currentScreen||0===this.currentScreen)&&(c=this.screens[this.currentScreen].btn)&&KIP.Functions.RemoveCSSClass(c,"selected");this.currentScreen=a;(c=b.btn)&&KIP.Functions.AddCSSClass(c,"selected");this.elems.hilites.innerHTML=
"";for(c=0;c<b.hilites.length;c+=1)if(e=b.hilites[c])d=KIP.Functions.CreateSimpleElement("hilite"+a+"|"+c,"hilite","","","",this.elems.hilites),f=e.elem.getBoundingClientRect(),g=KIP.Functions.CreateSimpleElement("","clone","","","",d),g.style.top=f.top+"px",g.style.left=f.left+"px",g.style.width=f.width+"px",g.style.height=f.height+"px",d=KIP.Functions.CreateSimpleElement("","lbl",e.content,"","",d),d.style.top=f.top+f.height+6+"px",d.style.left=f.left+"px",KIP.Functions.DoElementsOverlap(g,this.elems.description)||
KIP.Functions.DoElementsOverlap(void 0,this.elems.title)};KIP.Objects.Tutorial.prototype.AddInlineHelp=function(a,b){};KIP.Objects.Tutorial.prototype.NextInlineHelp=function(){};KIP.Objects.Tutorial.prototype.PreviousInlineHelp=function(){};
KIP.Objects.Tutorial.prototype.CreateElements=function(){var a=this;this.elems.hilites=KIP.Functions.CreateSimpleElement("hilites","hilites","","","",this.div);this.elems.content=KIP.Functions.CreateSimpleElement("content","content","","","",this.div);this.elems.wrapper=KIP.Functions.CreateSimpleElement("wrapper","wrapper","","","",this.elems.content);this.elems.title=KIP.Functions.CreateSimpleElement("title","title","","","",this.elems.wrapper);this.elems.description=KIP.Functions.CreateSimpleElement("desc",
"description","","","",this.elems.wrapper);this.elems.nav=KIP.Functions.CreateSimpleElement("nav","nav","","","",this.div);this.elems.previous=KIP.Functions.CreateSimpleElement("previousBtn","prev btn","PREVIOUS","","",this.elems.nav);this.elems.screens=KIP.Functions.CreateSimpleElement("screens","screens","","","",this.elems.nav);this.elems.next=KIP.Functions.CreateSimpleElement("nextBtn","next btn","NEXT","","",this.elems.nav);this.elems.next.addEventListener("click",function(){a.NextScreen()});
this.elems.previous.addEventListener("click",function(){a.PreviousScreen()});this.elems.closeWrapper=KIP.Functions.CreateSimpleElement("closeWrapper","closeWrapper","","","",this.div);this.elems.close=KIP.Functions.CreateSimpleElement("close","close btn","CLOSE","","",this.elems.closeWrapper);this.elems.close.addEventListener("click",function(){a.Hide()})};
KIP.Objects.Tutorial.prototype.AddStandardStyles=function(){var a;!KIP.Globals.StylesAdded.Tutorial&&this.options.useStandardStyles&&(KIP.Globals.StylesAdded.Tutorial=!0,a={top:0,left:0,position:"fixed",width:"100%",height:"100%","background-color":"rgba(0,0,0,.8)",opacity:0,transition:"opacity .2s ease-in-out","font-family":'"Segoe UI", "Calibri", sans-serif',"user-select":"none","-moz-user-select":"none","-webkit-user-select":"none","khtml-user-select":"none","o-user-select":"none"},KIP.Functions.CreateCSSClass(".tutorial",
a),a={opacity:1},KIP.Functions.CreateCSSClass(".tutorial.visible",a),a={color:"#FFF","font-size":"2em"},KIP.Functions.CreateCSSClass(".tutorial .content .title",a),a={display:"flex","justify-content":"center",height:"100%"},KIP.Functions.CreateCSSClass(".tutorial .content",a),a={"background-color":"rgba(0,0,0,.6)",padding:"5px"},KIP.Functions.CreateCSSClass(".tutorial .mask .title, .tutorial .mask .description",a),a={display:"flex","justify-content":"center","flex-direction":"column","z-index":1},
KIP.Functions.CreateCSSClass(".tutorial .wrapper",a),a={color:"#FFF"},KIP.Functions.CreateCSSClass(".tutorial .content .description",a),a={position:"absolute",left:0,width:"100%",display:"flex","justify-content":"center",top:"calc(100% - 1.5em)","font-size":"1em",color:"#FFF"},KIP.Functions.CreateCSSClass(".tutorial .nav",a),a={transition:"all ease-in-out .1s",margin:"0px 5px",cursor:"pointer",opacity:".8","z-index":1},KIP.Functions.CreateCSSClass(".tutorial .btn",a),a={display:"flex","justify-content":"center",
"align-items":"center"},KIP.Functions.CreateCSSClass(".tutorial .nav .screens",a),a={"background-color":"#FFF","border-radius":"0.7em",height:"0.7em",width:"0.7em",opacity:".5"},KIP.Functions.CreateCSSClass(".tutorial .screen.btn",a),a={transform:"scale(1.1)",opacity:"1"},KIP.Functions.CreateCSSClass(".tutorial .btn:hover, .tutorial .btn.selected",a),a={position:"absolute",top:"0.5em",color:"#FFF",width:"100%",left:0,display:"flex","justify-content":"flex-end"},KIP.Functions.CreateCSSClass(".tutorial .closeWrapper",
a),a={position:"absolute",border:"dotted 2px #FFF","background-color":"rgba(255,255,255,.2)"},KIP.Functions.CreateCSSClass(".tutorial .circle, .tutorial .clone",a),a={position:"absolute",color:"#FFF","padding-left":"0.1em"},KIP.Functions.CreateCSSClass(".tutorial .lbl",a))};KIP.Objects.Sidebar=function(a,b){var c=this;this.id=a;KIP.Objects.Drawable.call(this,a,"sidebar");this.options=b||{};this.options.maxWidth||(this.options.maxWidth="20%");this.options.resizable||(this.options.resizable=!0);this.options.width||(this.options.width=this.options.maxWidth);this.options.defaultTab||(this.options.defaultTab=0);this.options.position||(this.options.position="left");this.options.shrinkTo||(this.options.shrinkTo=0);this.elems={tabs:KIP.Functions.CreateSimpleElement("tabGrp",
"tabs","","","",this.div),tabContent:KIP.Functions.CreateSimpleElement("tabContent","tabContent","","","",this.div),button:KIP.Functions.CreateSimpleElement("sidebarBtn","btn","","","",this.div)};this.elems.innerTabs=KIP.Functions.CreateSimpleElement("intTabGrp","intTabs","","","",this.elems.tabs);this.elems.button.addEventListener("click",function(){c.expanded?c.Collapse():c.Expand()});this.options.preventStyles||this.AddStyles()};KIP.Objects.Sidebar.prototype=Object.create(KIP.Objects.Drawable.prototype);
KIP.Objects.Sidebar.prototype.Expand=function(){KIP.Functions.AddCSSClass(this.div,"expanded");this.expanded=!0};KIP.Objects.Sidebar.prototype.Collapse=function(){KIP.Functions.RemoveCSSClass(this.div,"expanded");this.expanded=!1};KIP.Objects.Sidebar.prototype.Resize=function(){};
KIP.Objects.Sidebar.prototype.AddStyles=function(){var a;KIP.Globals.AddedSidebarStyles||(KIP.Globals.AddedSidebarStyles=!0,a="left"===this.options.position?"0%":100-+this.options.maxWidth+"%",a={position:"fixed",left:a,top:0,height:"100%",transition:"width .2s ease-in-out","max-width":this.options.maxWidth,width:this.options.shrinkTo,"box-shadow":"1px 0px 5px 2px rgba(0,0,0,.2)","z-index":"0",display:"flex","background-color":"#DDD"},KIP.Functions.CreateCSSClass(".sidebar",a),a={width:this.options.width},
KIP.Functions.CreateCSSClass(".sidebar.expanded",a),a={position:"absolute",height:"5%",width:"15px",left:"calc(100% - 7px)",top:"47.5%","background-color":"#555","z-index":"2",cursor:"pointer"},KIP.Functions.CreateCSSClass(".sidebar #sidebarBtn",a),a={"overflow-x":"hidden",position:"relative",width:"87%","z-index":"1","background-color":"#FFF","box-shadow":"1px 1px 5px 2px rgba(0,0,0,.2)","margin-top":"2%","margin-bottom":"2%","box-sizing":"border-box"},KIP.Functions.CreateCSSClass(".sidebar .tabContent",
a),a={"overflow-y":"auto",padding:"10px"},KIP.Functions.CreateCSSClass(".sidebar.expanded .tabContent",a),a={overflow:"hidden",position:"relative",height:"100%",width:"10%","z-index":"1","padding-top":"5px"},KIP.Functions.CreateCSSClass(".sidebar .tabs",a),a={transform:"rotate(-90deg)","transform-origin":"0 0",display:"flex","justify-content":"flex-end","margin-top":"100%",width:"auto"},KIP.Functions.CreateCSSClass(".sidebar .tabs .intTabs",a),a={cursor:"pointer","white-space":"nowrap",margin:"0 10px",
padding:"5px"},KIP.Functions.CreateCSSClass(".sidebar .tabs .tab",a),a={"background-color":"#0066ff",color:"#FFF","border-radius":"5px"},KIP.Functions.CreateCSSClass(".sidebar .tabs .tab.selected, .sidebar .tabs .tab:hover",a))};
KIP.Objects.Sidebar.prototype.AddTab=function(a,b){var c,d,e,f;this.tabs||(this.tabs=[]);d=this.tabs.length;c=KIP.Functions.CreateSimpleElement("tab"+d,"tab",a);this.elems.innerTabs.appendChild(c);e={tabNameElem:c,tabName:a,tabContent:b};b.Draw?(e.tabContentElem=b.div,e.tabContentDrawable=b):b.appendChild?e.tabContentElem=b:"string"===typeof b&&(c=KIP.Functions.CreateSimpleElement("content-"+a,"tab",b),e.tabContentElem=c);this.tabs.push(e);f=this;e.tabNameElem.addEventListener("click",function(){f.SelectTab(d)});
this.options.defaultTab===d&&this.SelectTab(d)};KIP.Objects.Sidebar.prototype.SelectTab=function(a){KIP.Functions.AddCSSClass(this.tabs[a].tabNameElem,"selected");this.selectedTab&&KIP.Functions.RemoveCSSClass(this.selectedTab,"selected");this.selectedTab=this.tabs[a].tabNameElem;this.elems.tabContent.innerHTML="";this.tabs[a].tabContentDrawable?this.tabs[a].tabContentDrawable.Draw(this.elems.tabContent):this.elems.tabContent.appendChild(this.tabs[a].tabContentElem)};
