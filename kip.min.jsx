...
KIP.Objects.Color.prototype.IsLight=function(){this.hue||this.GenerateHSLValues();return 50<this.lightness};KIP.Objects.Drawable=function(a,b,c){this.div=KIP.Functions.CreateSimpleElement(a,b,c);this.children=[];this.style=this.div.style};KIP.Objects.Drawable.prototype.AppendChild=function(a,b,c){this.children||(this.children=[]);c||0===c||(c=this.children.length);a.Draw&&(this.children.splice(c,0,a),this.children[c].parent=b||this.div)};
...
KIP.Objects.SVGDrawable.prototype.CreateGroup=function(a){return this.AddChild("g",[],{},a)};KIP.Objects.SVGDrawable.prototype.SetAttribute=function(a,b){this.div.setAttribute(a,b)};KIP.Objects.SVGDrawable.prototype.Clear=function(){var a,b;for(b=this.div.children.length-1;1<=b;--b)a=this.div.children[b],this.div.removeChild(a)};KIP.Functions.DrawLine=function(a,b,c){var d,e;d=KIP.Functions.GetDistance(a,b);b=KIP.Functions.GetAngle(a,b);e=KIP.Functions.CreateSimpleElement("","angledLine");e.style.position="absolute";e.style.left=a.x+"px";e.style.top=a.y+"px";e.style.width=d+"px";e.style.height="1px";e.style.transformOrigin="0px 0px";e.style.transform="rotate("+b+"deg)";c.appendChild(e);return e};
...
this.hslRotate),void 0!==a.z&&(c=a.z),g=this.AddChild("path",{d:""},this.style,"","",e),h=this.AddText(g,a.lbl,a.x,a.y,this.fontStyle,"","","",f),this.AddLineListeners(g,h),this.MoveTo(a.x,a.y,g)):this.LineTo(a.x,a.y,g)};KIP.Globals.HoverOffsetEnum={Top:1,TopRightAlign:17,Bottom:2,BottomRightAlign:18,Left:4,LeftBottomAlign:36,Right:8,RightAlign:16,BottomAlign:32,RightBottomAlign:40,"Top-Left":5,"Top-Right":9,"Bottom-Left":6,"Bottom-Right":10,Custom:0};
