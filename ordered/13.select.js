	...
	for (i = 0; i < this.data.length; i += 1) {
		...
		if (idx === -1) {
			if (this.visible[i]) {
				...
				if (i === this.selectedData) this.selectedData = -1;
...
KIP.Objects.Select.prototype.Validate = function () {
	...
	if (this.selectedData !== -1) {
		if ((this.data[this.selectedData].key.indexOf(str) >= 0) || (this.data[this.selectedData].val.indexOf(str) >= 0)) {
